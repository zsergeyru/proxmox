...
На хосте фактически существуют только две VM:
...
VM `100` описывается в [`../../guests/100-haos/`](../../guests/100-haos/) как текущая legacy Home Assistant VM.
...
Здесь фиксируется наблюдаемое и воспроизводимое состояние самого PVE-хоста. Целевые параметры VM/LXC принадлежат их каталогам `guests/`, а прикладные конфигурации внутри гостей — их `rootfs/`.
