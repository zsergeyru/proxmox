...
**Тип:** Архивная спецификация  
**Статус:** Устаревший контур  
**Основной источник:** Нет — новый шаблон `9000` описывается в `packer/9000/`.

> Этот документ сохранён временно для сравнения с прежней версией 7 и будет удалён после успешной реальной Packer-сборки версии 8.
