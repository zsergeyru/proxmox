...
Изменяющие права 910 распространяются на путь Proxmox `/vms`, то есть на все VM/LXC. Pool `managed` остаётся отдельной границей для AI Control и не ограничивает infra-deployer.
