...
Через общий гостевой контур для 410 запрашивается:
...
Для исходящего административного SSH 410 получает собственную identity:
...
Закрытый SSH-ключ остаётся только внутри 410.
